...
predict_ecta_new <- function(str){
  if(get_wordcount(str)>=5){
    ...
    as.character(ecta_df[(ecta_df$w1==new_str[1] & ecta_df$w2==new_str[2] & 
               ecta_df$w3==new_str[3] & ecta_df$w4==new_str[4] & ecta_df$w5==new_str[5]),][,6][1])
  } else {NA}
}
